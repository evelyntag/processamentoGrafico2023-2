...
int velocidadeXBase = 5;

Sprite::Sprite()
{
	//Inicializar outros atributos
	velY = 20;
	velX = velocidadeXBase;
}
...
void Sprite::aumentaVelocidadeX()
{
	velX += 2;
}

void Sprite::resetaVelocidadeX()
{
	velX = velocidadeXBase;
}
...
void Sprite::moveUp()
{
	position.y = position.y + velY > 440 ? 440 : position.y + velY;
}

void Sprite::moveDown()
{
	position.y = position.y - velY < 160 ? 160 : position.y - velY;
}
